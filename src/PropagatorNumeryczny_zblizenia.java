...
public class PropagatorNumeryczny_zblizenia {
...
//ELEMENTY OBIEKTU GłÓWNEGO
            ...
            double roznica = sekPlusMili1 - sekPlusMili;
...
//definiuję początkową orbitę - Keplerian Orbit
            double type1 = elements_map.get("type");
            ...
            if (type1 == 1) {
                ...
                area1 = elements_map.get("area1"); // satellite area
            ...
            //definiuję początkową orbitę - Cartesian Orbit
                ...
                double x1 = elements_map.get("x");                 // semi major axis in meters
                double y1 = elements_map.get("y");               // eccentricity
                double z1 = elements_map.get("z");        // inclination
                double vx1 = elements_map.get("vx");  // perigee argument
                double vy1 = elements_map.get("vy");   // right ascension of ascending node
                double vz1 = elements_map.get("vz");  // mean anomaly
...
// with a minimum step of 0.001 and a maximum step of 1000
            ...
            //propagationTime = propagationTime + date2obToIniDate;
            double[][] tolerances1 =
